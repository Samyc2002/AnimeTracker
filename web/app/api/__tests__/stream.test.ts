  ...
  it("returns 9anime and kickass URLs when both searches succeed", async () => {
    global.fetch = vi
      ...
      .mockResolvedValueOnce({
        ok: true,
        text: async () =>
          '<a href="/anime/naruto-shippuden/" itemprop="url">Naruto</a><a href="/anime/naruto/" itemprop="url">Naruto</a>',
      })
      .mockResolvedValueOnce({
        ok: true,
        text: async () =>
          '<a href="https://anikoto.cz/watch/road-of-naruto-ggjw8/" itemprop="url">Naruto</a><a href="https://anikoto.cz/watch/naruto/" itemprop="url">Naruto</a>',
      });
    ...
    expect(body.urlAnikoto).toBe("https://anikoto.cz/watch/naruto");
  });
